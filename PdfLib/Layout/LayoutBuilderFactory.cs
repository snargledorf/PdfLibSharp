...
{
    public ILayoutBuilder GetLayoutBuilder(IElement element, Font font, StringFormat stringFormat)
    {
        return element switch
        {
            IStackContainer container => container.GetLayoutBuilder(font, stringFormat, this),
